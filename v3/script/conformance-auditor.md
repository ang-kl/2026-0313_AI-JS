...
- `doc/v3-result-engine-spec.md` §6 (hard gates) and §3 (radicality — an audit of a FROZEN surface should find zero diff).
...
1. Prov chip on every figure.
1. Withhold / `[UNVERIFIED]` over fabrication.
1. Range over fake point.
1. Snapshot determinism on the 3 fixtures.
