              ...
              item.promptLoading
                ? <div style={{ marginTop:8, padding:"10px 12px", background:"#f0f9ff", border:"1px solid #bae6fd", borderRadius:7 }}>
                    <div style={{ display:"flex", alignItems:"center", gap:8, marginBottom:8 }}>
                      ...
                      <p style={{ margin:0, fontSize:11, color:"#0369a1", fontStyle:"italic", fontWeight:600 }}>
                    ...
                    <p style={{ margin:"0 0 4px", fontSize:11, color:"#0369a1", lineHeight:1.55 }}>
                      A prompt suited to this level is being written - with a specific technique matched to a {item.level === "HIGH" ? "Full Automation" : item.level === "MEDIUM" ? "AI-Augmented" : "AI-Assisted"} {item.skillType === "soft-skill" ? "soft skill" : "technical skill"}.
                    </p>
