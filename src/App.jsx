// v1.5.3 - 2026-03-18 - Chat 6 - no markdown in prompts, explicit newline paragraph rule
...
PLAIN TEXT RULE: The p field must be plain text only. No markdown. No asterisks, no bold (**text**), no headers (##), no bullet points (-), no numbered lists. Plain sentences only.
