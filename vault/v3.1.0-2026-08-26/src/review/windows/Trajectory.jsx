// v3/src/review/windows/Trajectory.jsx - PR 1 (Part B.4): window body moved VERBATIM from
...
export function renderWinTrajectory(ctx) {
  ...
  return (
    <div style={{ maxWidth: 880 }}><div style={{ display: "flex", flexDirection: "column" }}>{secTrajectory}</div>{!critical.trajectory && <p style={manuP}>Withheld - fewer than 4 engine-classified duties so far.</p>}</div>
  );
}
