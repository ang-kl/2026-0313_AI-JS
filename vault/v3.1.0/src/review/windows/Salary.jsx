// v3/src/review/windows/Salary.jsx - PR 1 (Part B.4): window body moved VERBATIM from
...
export function renderWinSalary(ctx) {
  ...
  return (
    <div style={{ maxWidth: 880 }}><div style={{ display: "flex", flexDirection: "column" }}>{secSalaryPos}</div>{!critical.salaryPos && <p style={manuP}>Withheld - this ad states no salary band, or too few comparable salary-stating ads were sampled.</p>}</div>
  );
}
