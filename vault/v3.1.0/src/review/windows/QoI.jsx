// v3/src/review/windows/QoI.jsx - PR 1 (Part B.4): window body moved VERBATIM from
...
export function renderWinQoI(ctx) {
  ...
  return (
    <div style={{ maxWidth: 880 }}><div style={{ display: "flex", flexDirection: "column" }}>{secQoI}</div>{!critical.qoi.length && <p style={manuP}>No gradeable requirement claims in this ad - nothing is graded that was not written.</p>}</div>
  );
}
