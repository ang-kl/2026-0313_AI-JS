...
**Register snapshot SHA-256:** `a39abe5291a660125cefa010bb780cf6a4d492b733c433dfa30787f4c9c2ea47`  
...
- `1` requirement `IMPLEMENTED_UNVERIFIED`: `BLP-006`.
- `25` requirements `NOT_STARTED`: `BLP-005`, `BLP-007` through `BLP-030`.
...
| `IMPLEMENTED_UNVERIFIED` | 1 | `BLP-006` |
| `NOT_STARTED` | 25 | `BLP-005`, `BLP-007` through `BLP-030` |
| `IN_PROGRESS` | 0 | None |
