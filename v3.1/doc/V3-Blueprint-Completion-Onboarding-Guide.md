...
**Register snapshot SHA-256:** `458377e3867033f44e9dbcc09fd247f9beffdd2bd92f316f02c72b2ba23c5959`  
...
- `1` requirement `IMPLEMENTED_UNVERIFIED`: `BLP-007`.
- `23` requirements `NOT_STARTED`: `BLP-008` through `BLP-030`.
...
| `IMPLEMENTED_UNVERIFIED` | 1 | `BLP-007` |
| `NOT_STARTED` | 23 | `BLP-008` through `BLP-030` |
| `IN_PROGRESS` | 0 | None |
...
| `BLP-007` | P1 | `IMPLEMENTED_UNVERIFIED` | Capture exact candidate-evidence excerpts with immutable source and span identifiers. | `BLP-002`, `BLP-003` |
