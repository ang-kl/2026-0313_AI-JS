...
**Register snapshot SHA-256:** `fcd0b7814233360d1625d05ad27de9c6f7afc336b3a302320aeb1690532ca4ff`  
...
- `19` requirements `NOT_STARTED`: `BLP-012` through `BLP-030` (code for `BLP-012` through `BLP-028` was merged and deployed by PR #508 on 2026-09-16 ahead of any register record; their status awaits the Blueprint Supervisor's rulings).
