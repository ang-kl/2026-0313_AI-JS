...
**Current main observed:** `15a20c650e306b89dd11baa7b09fda3bd7714f3d` (`feat(v3.1): BLP-007 exact candidate-evidence excerpts; BLP-005 approved COMPLETE, P0 gate closed (#498)`)  
**Completion programme:** `V3-BLUEPRINT-COMPLETION-REGISTER-001`  
**Register snapshot SHA-256:** `9c6874cbeae03e47dda9b84d960d0586c962a11e63fb022d41b6d19aed1ecd94`  
...
- `7` requirements approved as `COMPLETE`: `BLP-001` through `BLP-007`; the P0 gate is closed and the first P1 requirement is approved.
- `1` requirement `IMPLEMENTED_UNVERIFIED`: `BLP-008`.
- `22` requirements `NOT_STARTED`: `BLP-009` through `BLP-030`.
...
|---|---:|---|
| `COMPLETE` | 7 | `BLP-001`, `BLP-002`, `BLP-003`, `BLP-004`, `BLP-005`, `BLP-006`, `BLP-007` |
| `IMPLEMENTED_UNVERIFIED` | 1 | `BLP-008` |
| `NOT_STARTED` | 22 | `BLP-009` through `BLP-030` |
| `IN_PROGRESS` | 0 | None |
...
| `BLP-008` | P1 | `IMPLEMENTED_UNVERIFIED` | Build the structured candidate-proof ledger. | `BLP-007` |
