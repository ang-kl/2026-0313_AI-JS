...
**Register snapshot SHA-256:** `02b686cb2a7ec90954a09e1b8d984debfdcd4dd348a79e8c8e76512b429c361c`  
...
2. Two coverage gaps are open with the Human Lead, neither blocking `BLP-013`: `wu-open-print-package` is owned by no canonical requirement, and this guide's own build is owned by none either, which is what let its HTML go stale in the #511 arc. Re-link, declare conflict and resolve conflict are unwired and unmeasured, owned by `BLP-009` and `BLP-010`; if no future requirement will drive them, that is a third gap in the same terms.
