...
- `9` requirements approved as `COMPLETE`: `BLP-001` through `BLP-009`; the P0 gate is closed and the first three P1 requirements are approved.
- `1` requirement `IMPLEMENTED_UNVERIFIED`: `BLP-010`.
- `20` requirements `NOT_STARTED`: `BLP-011` through `BLP-030`.
...
|---|---:|---|
| `COMPLETE` | 9 | `BLP-001`, `BLP-002`, `BLP-003`, `BLP-004`, `BLP-005`, `BLP-006`, `BLP-007`, `BLP-008`, `BLP-009` |
| `IMPLEMENTED_UNVERIFIED` | 1 | `BLP-010` |
| `NOT_STARTED` | 20 | `BLP-011` through `BLP-030` |
| `IN_PROGRESS` | 0 | None |
...
| `BLP-010` | P1 | `IMPLEMENTED_UNVERIFIED` | Support demonstrated, certified, claimed-only, withheld, conflicting, and stale proof states. | `BLP-008`, `BLP-009` |
