...
export default function OrganisationMap({ result, roleTitle, organisationName, onBack, onEvidenceSelect, onOpenCompanyEvidence }) {
    ...
    <section className="om-root" data-testid="organisation-map" aria-label="Organisation Map">
      ...
      <header className="om-head">
        ...
        <div className="om-actions">
          ...
          <button data-testid="organisation-map-company-evidence" type="button" className="om-action primary" onClick={onOpenCompanyEvidence}>Company evidence workspace →</button>
        </div>
      </header>
