...
import OrganisationSynthesis from "./OrganisationSynthesis.jsx";
  ...
  return (
    <section className="om-root" data-testid="organisation-map" aria-label="Organisation Map">
      ...
      <div className="om-map">
        <OrganisationSynthesis result={result} onEvidenceSelect={onEvidenceSelect} />
