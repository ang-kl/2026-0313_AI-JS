  ...
  return (
    <section className="ovs-root" data-testid="occupation-visual-selector" aria-label="Occupation-sensitive visual selector">
      <style>{`
        ...
        @media(max-width:560px){.ovs-ribbon{grid-template-columns:repeat(${OCCUPATION_VISUALS.length},122px);min-width:max-content}.ovs-choice{min-height:44px}}
      `}</style>
