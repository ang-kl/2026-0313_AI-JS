      ...
      {tab === "duties" && showSuggest && (
        <div className="wis-scroll" style={{ flex: "none", display: "flex", flexWrap: "wrap", alignItems: "center", gap: 8, padding: "7px 14px", background: "#f5f1fc", borderBottom: "1px solid #ddd0f5", overflowX: "auto" }}>
          ...
          {suggestState.items.map((it) => (
            <span key={it.id} data-suggest-id={it.id} title={"AI-suggested link. Source: AI suggestion (LLM) - Confidence: advisory, not a fact - Time-window: this session. Review before you keep it."} style={{ display: "inline-flex", alignItems: "center", gap: 6, maxWidth: 440, background: "#fff", border: "1px dashed #b79ae8", borderRadius: 12, padding: "3px 5px 3px 10px", fontSize: "0.75rem", color: "#1e293b", flex: "none" }}>
